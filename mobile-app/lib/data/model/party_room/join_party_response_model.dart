...
//
//     final JoinPartyResponseModel = roomDetailsResponseModelFromJson(jsonString);
...
JoinPartyResponseModel roomDetailsResponseModelFromJson(String str) => JoinPartyResponseModel.fromJson(json.decode(str));

String roomDetailsResponseModelToJson(JoinPartyResponseModel data) => json.encode(data.toJson());

class JoinPartyResponseModel {
  String? remark;
  String? status;
  Message? message;
  Data? data;

  JoinPartyResponseModel({
    this.remark,
    this.status,
    this.message,
    this.data,
  ...
  factory JoinPartyResponseModel.fromJson(Map<String, dynamic> json) => JoinPartyResponseModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        partyRoom: json["party"] == null ? null : PartyRoom.fromJson(json["party"]),
...
class ItemVideo {
  ...
  factory ItemVideo.fromJson(Map<String, dynamic> json) => ItemVideo(
        ...
        adsTime: json["ads_time"] == null ? [] : List<String>.from(json["ads_time"]!.map((x) => x.toString())),
