...
class WatchHistoryResponseModel {
  ...
  WatchHistoryResponseModel.fromJson(dynamic json) {
    _remark = json['remark'];
    _status = json['status'];
...
class MainData {
  ...
  MainData.fromJson(dynamic json) {
    _histories = json['histories'] != null ? Histories.fromJson(json['histories']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (_histories != null) {
      map['histories'] = _histories?.toJson();
    }
    return map;
  }
}
...
class Histories {
  Histories({List<Data>? data, String? nextPageUrl}) {
    _data = data;
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _episode = json['episode'] != null ? Episodes.fromJson(json['episode']) : null;
  }
  int? _id;
  String? _userId;
  String? _itemId;
...
class Item {
  ...
  Item.fromJson(dynamic json) {
    ...
    _view = json['view'] != null ? json['view'].toString() : '';
    _createdAt = json['created_at'];
    _updatedAt = json['updated_at'];
  }
  int? _id;
