                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        (controller.wishlist[index].item?.title ?? '').tr,
                                                      ...
                                                      RatingAndWatchWidget(
                                                          watch: controller.wishlist[index].item?.view ?? '0',
                                                          rating: controller.wishlist[index].item?.ratings ?? '0'),
                                                    ],
                                                  ),
                                                ),
                                                const SizedBox(
                                                ...
                                                GestureDetector(
                                                  onTap: () {
                                                    AppDialog().closePartyDialog(context, () {
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: const BoxDecoration(
                                                        shape: BoxShape.circle, color: MyColor.textFieldColor),
                                            ...
                                            Text(
                                              (controller.wishlist[index].item?.description ?? '').tr,
                                              overflow: TextOverflow.fade,
                                              maxLines: 3,
                                              style: mulishRegular.copyWith(
                                                  color: MyColor.primaryText, fontSize: Dimensions.fontSmall),
                                            )
                                          ],
                                        ),
                                      ),
                                  ...
                                  Divider(
                                    color: controller.wishlist.length - 1 == index && !controller.hasNext()
                                        ? Colors.transparent
                                        : MyColor.bodyTextColor,
                                  ),
                                  SizedBox(
                                    height: controller.wishlist.length - 1 == index && !controller.hasNext() ? 0 : 10,
                                  )
                                ],
                              ),
                            ),
