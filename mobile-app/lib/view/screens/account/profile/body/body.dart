                  ...
                  : SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          ProfileWidget(
                            isEdit: comeFrom == 'profile' ? true : false,
                            imagePath: controller.imageUrl,
                            onClicked: () async {},
                          ),
                          Center(
                            child: comeFrom == "profile"
                                ? LabelText(
                                    text: '${MyStrings.username.tr} : ${controller.model.data?.user?.username ?? controller.profileRepo.apiClient.sharedPreferences.getString(SharedPreferenceHelper.userNameKey)}',
                                  )
                          ...
                          Visibility(
                            visible: comeFrom == 'profile' ? true : false,
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const SizedBox(height: 15),
                          ...
                          CustomTextField(
                            ...
                            nextFocus: controller.currentAdultPinFocusNode,
                          ),
                          const SizedBox(height: 15),
                          const LabelText(space: 12, text: MyStrings.currentAdultPin),
                          CustomTextField(
                            hintText: MyStrings.currentAdultPin,
                            isShowBorder: true,
                            isPassword: true,
                            isShowSuffixIcon: false,
                            inputType: TextInputType.number,
                            inputAction: TextInputAction.next,
                            focusNode: controller.currentAdultPinFocusNode,
                            controller: controller.currentAdultPinController,
                            onChanged: (value) {},
                            nextFocus: controller.adultPinFocusNode,
                          ),
                          const SizedBox(height: 15),
                          const LabelText(space: 12, text: MyStrings.newAdultPin),
                          CustomTextField(
                            hintText: MyStrings.newAdultPin,
                            isShowBorder: true,
                            isPassword: true,
                            isShowSuffixIcon: false,
                            inputType: TextInputType.number,
                            inputAction: TextInputAction.done,
                            focusNode: controller.adultPinFocusNode,
                            controller: controller.adultPinController,
                            onChanged: (value) {},
                          ),
                          const SizedBox(
                            height: 12,
