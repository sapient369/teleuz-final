...
class BottomNavyBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(color: bgColor, boxShadow: [if (showElevation) const BoxShadow(color: Colors.black12, blurRadius: 2)]),
      child: SafeArea(
        child: Container(
            ...
            children: items.map((item) {
              ...
              return GestureDetector(
                ...
                child: _ItemWidget(
                  ...
                  backgroundColor: bgColor ?? MyColor.cardBg,
