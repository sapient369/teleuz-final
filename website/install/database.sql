...
--
-- Table structure for table `channel_category_live_television`
--

CREATE TABLE `channel_category_live_television` (
  `channel_category_id` int NOT NULL,
  `live_television_id` bigint UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `adult_password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,  
...
--
-- Indexes for table `channel_category_live_television`
--
ALTER TABLE `channel_category_live_television`
  ADD KEY `channel_category_id` (`channel_category_id`),
  ADD KEY `live_television_id` (`live_television_id`);
