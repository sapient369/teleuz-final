...
class LiveTelevisionController extends Controller {
    ...
    public function categoryStore(Request $request, $id = 0) {
        ...
        $category->is_adult = $request->is_adult ? 1 : 0;
        $category->save();
    ...
    public function channel() {
        ...
        $televisions = LiveTelevision::searchable(['title'])->latest()->with('categories')->paginate(getPaginate());
    ...
    public function channelStore(Request $request, $id = 0) {
        ...
        $request->validate([
            ...
            'channel_category_ids' => 'required|array|min:1',
            'channel_category_ids.*' => 'integer|exists:channel_categories,id',
        ...
        $television->channel_category_id = $request->channel_category_ids[0];
        $television->save();

        $television->categories()->sync($request->channel_category_ids);
