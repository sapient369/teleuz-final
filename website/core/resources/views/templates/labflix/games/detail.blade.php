            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="social-list">
                        ...
                        <li class="social-list__item"><a target="_blank" href="https://t.me/share/url?url={{ urlencode(url()->current()) }}&amp;text={{ __(@$game->slug) }}" class="social-list__link telegram"> <i class="lab la-telegram-plane"></i></a></li>
                    </ul>
                    <div class="bar">
