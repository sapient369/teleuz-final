                        ...
                        <div class="movie-content-inner d-sm-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="movie-content-right mt-sm-0 mt-3">
                                ...
                                <ul class="post-share d-flex align-items-center justify-content-sm-end justify-content-start flex-wrap">
                                    ...
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('Instagram')">
                                        <a href="https://www.instagram.com/?url={{ urlencode(url()->current()) }}"><i class="lab la-instagram"></i></a>
                                    </li>
                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('Telegram')">
                                        <a href="https://t.me/share/url?url={{ urlencode(url()->current()) }}&amp;text={{ __(@$item->title) }}"><i class="lab la-telegram-plane"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
